...
class MainActivity : AppCompatActivity() {
    ...
    var previousMenuIteam : MenuItem? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drawerLayout.addDrawerListener(actionBarDrawerToggle) //this is the line which enables hamburger icon to work
        actionBarDrawerToggle.syncState()
        navigationView.setNavigationItemSelectedListener {
            if(previousMenuIteam != null){
                previousMenuIteam?.isChecked = false
            }
            it.isCheckable = true
            it.isChecked = true
            previousMenuIteam = it
            when(it.itemId){
                R.id.dashboard -> {
                    openDashboard()
